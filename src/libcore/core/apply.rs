...
pub trait CoreFunction {
    fn core_apply(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_eval(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_fix(_: &Env, _: &mut Frame) -> exception::Result<()>;
}
...
impl CoreFunction for Env {
    ...
    fn core_apply(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let func = fp.argv[0];
        let args = fp.argv[1];
