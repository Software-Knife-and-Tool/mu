...
pub trait CoreFunction {
    fn core_hp_info(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_hp_size(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_hp_stat(_: &Env, _: &mut Frame) -> exception::Result<()>;
}

impl CoreFunction for Heap {
    fn core_hp_stat(env: &Env, fp: &mut Frame) -> exception::Result<()> {
    ...
    fn core_hp_info(env: &Env, fp: &mut Frame) -> exception::Result<()> {
    ...
    fn core_hp_size(env: &Env, fp: &mut Frame) -> exception::Result<()> {
