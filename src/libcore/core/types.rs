...
pub trait CoreFunction {
    fn core_eq(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_typeof(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_repr(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_view(_: &Env, _: &mut Frame) -> exception::Result<()>;
}

impl CoreFunction for Tag {
    fn core_repr(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let type_ = fp.argv[0];
        let arg = fp.argv[1];
    ...
    fn core_eq(_: &Env, fp: &mut Frame) -> exception::Result<()> {
    ...
    fn core_typeof(_: &Env, fp: &mut Frame) -> exception::Result<()> {
    ...
    fn core_view(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let tag = fp.argv[0];
