...
pub trait CoreFunction {
    fn core_fladd(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_flsub(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_flmul(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_fllt(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_fldiv(_: &Env, _: &mut Frame) -> exception::Result<()>;
}

impl CoreFunction for Float {
    fn core_fladd(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
    ...
    fn core_flsub(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
    ...
    fn core_flmul(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
    ...
    fn core_fldiv(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
    ...
    fn core_fllt(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
