...
pub trait CoreFunction {
    fn core_close(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_flush(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_get_string(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_open(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_openp(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_read_byte(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_read_char(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_unread_char(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_write_byte(_: &Env, _: &mut Frame) -> exception::Result<()>;
    fn core_write_char(_: &Env, _: &mut Frame) -> exception::Result<()>;
}
...
impl CoreFunction for Stream {
    ...
    fn core_open(env: &Env, fp: &mut Frame) -> exception::Result<()> {
    ...
    fn core_read_char(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let stream = fp.argv[0];
    ...
    fn core_read_byte(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let stream = fp.argv[0];
        let eof_error_p = fp.argv[1];
        let eof_value = fp.argv[2];
    ...
    fn core_unread_char(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let ch = fp.argv[0];
    ...
    fn core_write_char(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let ch = fp.argv[0];
        let stream = fp.argv[1];
    ...
    fn core_write_byte(env: &Env, fp: &mut Frame) -> exception::Result<()> {
        let byte = fp.argv[0];
        let stream = fp.argv[1];
