...
pub trait MuFunction {
    ...
    fn lib_fllt(_: &Mu, _: &mut Frame) -> exception::Result<()>;
...
impl MuFunction for Float {
    ...
    fn lib_flsub(mu: &Mu, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
    ...
    fn lib_flmul(mu: &Mu, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
    ...
    fn lib_fldiv(mu: &Mu, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
    ...
    fn lib_fllt(mu: &Mu, fp: &mut Frame) -> exception::Result<()> {
        let fl0 = fp.argv[0];
        let fl1 = fp.argv[1];
